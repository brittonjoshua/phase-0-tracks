##RELEASE 0 Write a method that takes an array of integers and the integer to search for.
#The method should iterate through and return the index of the item.
